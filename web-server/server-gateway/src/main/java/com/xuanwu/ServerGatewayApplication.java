...
import com.xuanwu.filter.AuthReqFilter;
import com.xuanwu.filter.RateLimiterFilter;
import com.xuanwu.filter.ReadFilter;
import com.xuanwu.filter.UrlParamFilter;
import com.xuanwu.filter.WriteFilter;
...
public class ServerGatewayApplication {
	...
	@Bean
	public UrlParamFilter routeFilter(){
		return new UrlParamFilter();
	}
	@Bean
	...
	@Bean
	public AuthReqFilter authReqFilter(){
